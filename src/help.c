...
struct help_type help_table[] =
{
	...
	},
	{
		...
		"\n"
		"         @find{str;pat;pos}    Find pattern in string, pos is optional\n"
		"         @substr{str;pos;len}  Get substring of str, len is optional\n"
		"\n"
		"         Misc functions defined in tintinrc\n"
		"\n"
		"         @which{if;then;else}  Reurn then or else depending if is true\n"
		"         @max{val;val;...}     Maximum value among arguments\n"
		"         @min{val;val;...}     Minimum value among arguments\n"
		"         @abs{val}             Absolute value\n"
		"         @int{val}             Integer part of number\n"
		"         @div{a;b}             Integer division @int(a/b)\n"
		"         @mod{a;n}             Integer modulo n of a\n"
		"         @round{a;n}           Rounding of n fractional precision\n"
		"         @pow{a;b}             Power of number a**b\n"
		"         @sqrt{num}            Squareroot of number\n"
		"         @rand{min;max}        Random number bwteen [min, max]\n"
		"         @dice{a;b}            b-face dice-rolloing, a*[1, b]\n"
		"         @eval{exp}            Do math on exp and return result\n"
		"         @toarray{var}         Convert simple list to numbred array\n"
		"         @tosimple{var}        Convert array to simple list\n"
		"         @format{fmt;var;...}  #format in function form\n"
		"         @numgrp{num}          Group digits in number by thousands\n"
		"         @numungrp{num}        Remove all ',' separators in number\n"
		"         @lower{str}           To lower-case string\n"
		"         @upper{str}           To upper-case string\n"
		"         @capital{word}        Capitalize first character\n"
		"         @trim{str}            Trim whitespaces on both end\n"
		"         @replace{str;pat;rep} Replace pat with rep in string\n"
		"         @fill{fil;num}        Repeat fil string num times\n"
		"         @strlen{str}          Number of characters in string\n"
		"         @strwidth{str}        Width of string on terminal screen\n"
		"         @checksum{str}        Checksum/hash of str, max 64 bit sum\n"
	},
	{
		"GAG",
...
//		"<068>      #<078>           (<068>T<078>)he k(<068>I<078>)cki(<068>N<078>) (<068>T<078>)ickin d(<068>I<078>)kumud clie(<068>N<078>)t <068>          #\n"
	...
	},
	{
		...
		"         #list {var} {merge} {variable} {del}   Merge all items to {variable},\n"
		"                                                delimeter {del} is optional.\n"
	...
	{
		"LUA",
		"<K82>Command<K81>: #lua <K82>{<K81><variable><K82>} {<K81><script><K82>} <K82>{<K81>argument1<K82>} {<K81>argument2<K82>} {<K81>etc<K82>}<K81>\n"
		"\n"
	...
	},
	{
		...
		"\n"
		"         You can comment out triggers using /* text */ or a // (C++ syle)\n"
	},
	{
		"REGEXP",
