...
struct help_type help_table[] =
{
	...
	},
	{
		...
		"\n"
		"   <K82>Note<K81>: You can remove an alias with the #unalias command.\n"
	},
	{
		"ALL",
	...
	},
	{
		...
		"\n"
		"         <<888>6dd> codes are special code:\n"
		"         <<888>622>: normal non-bold, non-dim    <<888>624>: end underscore\n"
		"         <<888>625>: end blink                   <<888>627>: end reverse\n"
		"         <<888>639>: default foreground color    <<888>649>: default background color\n"
		"\n"
		...
		"         ${_TK[00]}-${_TK[99]} global array variables. <<888>K80>-<<888>K99> codes\n"
		"         are reserved for help / chat colors and future internal use.\n"
		"\n"
		"     <K82>Ex<K81>: #showme <<888>xFF69B4>Pink text and <<888>XE0FFFF>Light cyan BG\n"
		"     <K82>Ex<K81>: #var {_TK[04]} {<<888>118>}; #showme <<888>K04>Bold Red color\n"
	},
	{
		"CONFIG",
	...
	},
	{
		...
		"   <K82>Note<K81>: See '#help action', for more information about triggers.\n"
		"\n"
		"   <K82>Note<K81>: You can remove a gag with the #ungag command.\n"
	},
/*
	{
		"GREETING",
...
//		"<068>      #<078>           (<068>T<078>)he k(<068>I<078>)cki(<068>N<078>) (<068>T<078>)ickin d(<068>I<078>)kumud clie(<068>N<078>)t <068>          #\n"
	...
	},
	{
		...
		"\n"
		"         none, reset, bold, dim, underscore, blink, reverse\n"
		"         normal (not bold or dim), ununderscore, unblink, unreverse\n"
		"\n"
		"         black, red, green, yellow, blue, magenta, cyan, white, default\n"
		"         Add 'bg' or 'background' prefix like 'bg red' for background red color.\n"
		"\n"
		"         Available XTERM 256 color names are:\n"
		"\n"
		"         azure, ebony, jade, lime, orange, pink, silver, tan, violet,\n"
		"         Add 'lt' or 'light' prefix like 'lt azure' for light azure color.\n"
		"\n"
		...
		"   <K82>Note<K81>: See '#help action', for more information about triggers.\n"
		"\n"
		"   <K82>Note<K81>: See '#help substitute', for more advanced color substitution.\n"
		"\n"
		"   <K82>Note<K81>: This command only works with ANSI/VT100 terminals or emulators.\n"
		"\n"
		"   <K82>Note<K81>: You can remove a highlight with the #unhighlight command.\n"
	},
	{
		"HISTORY",
	...
	{
		"LOG",
		"<K82>Command<K81>: #log <K82>{<K81>append<K82>|<K81>overwrite<K82>|<K81>off<K82>}<K81> <K82>{<K81>filename<K82>}<K81>\n"
		"\n"
...

	{
		...
		"\n"
		"   <K82>Note<K81>: You can remove a macro with the #unmacro command.\n"
	},
	{
		"MAP",
		"<K82>Command<K81>: #map\n"
	...
	},
	{
		...
		"\n"
		"   <K82>Note<K81>: By using braces you can comment out multiple lines of code in a script\n"
		"         file.\n"
		"\n"
	...
	},
	{
		...
		"   <K82>Note<K81>: See '#help action', for more information about triggers.\n"
		"\n"
		"   <K82>Note<K81>: You can remove a prompt with the #unprompt command.\n"
	},
	{
		"READ",
	...
	},
	{
		...
		"\n"
		"   <K82>Note<K81>: You can display text on the split line(s) with the #prompt and\n"
		"         #showme {line} {row} command.\n"
		"\n"
		"   <K82>Note<K81>: You can remove split mode with the #unsplit command.\n"
	},
	{
		"SSL",
	...
	},
	{
		...
		"   <K82>Note<K81>: See '#help action', for more information about triggers.\n"
		"\n"
		"   <K82>Note<K81>: See '#help colors', for more information.\n"
		"\n"
		"   <K82>Note<K81>: You can remove a substitution with the #unsubstitute command.\n"
	},
	{
		"SUSPEND",
	...
	},
	{
		...
		"\n"
		"   <K82>Note<K81>: You can remove a tab with the #untab command.\n"
	},
	{
		"TEXTIN",
	...
	},
	{
		...
		"\n"
		"   <K82>Note<K81>: Tickers don't work in the startup session.\n"
		"\n"
		"   <K82>Note<K81>: You can remove a ticker with the #unticker command.\n"
	},
	{
		"VARIABLE",
		...
		"\n"
		"   <K82>Note<K81>: Related commands are local, math, format, and list.\n"
		"\n"
		"   <K82>Note<K81>: You can remove a variable with the #unvariable command.\n"
	},
	{
		"WHILE",
