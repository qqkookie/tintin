...
#define SES_FLAG_ECHOCOMMAND          (1LL <<  1)
#define SES_FLAG_SNOOP                (1LL <<  2)
#define SES_FLAG_MCCP                 (1LL <<  3)
#define SES_FLAG_MAPPING              (1LL <<  4)
#define SES_FLAG_SPLIT                (1LL <<  5)
#define SES_FLAG_SPEEDWALK            (1LL <<  6)
#define SES_FLAG_READMUD              (1LL <<  8)
#define SES_FLAG_WORDWRAP             (1LL <<  9)
#define SES_FLAG_VERBATIM             (1LL << 10)
#define SES_FLAG_CONNECTED            (1LL << 11)
#define SES_FLAG_REPEATENTER          (1LL << 12)
#define SES_FLAG_VERBOSE              (1LL << 13)
//#define SES_FLAG_VERBOSELINE          (1LL << 14)
#define SES_FLAG_LOGLEVEL             (1LL << 15)
#define SES_FLAG_LOGPLAIN             (1LL << 16)
#define SES_FLAG_LOGHTML              (1LL << 17)
#define SES_FLAG_GAG                  (1LL << 18)
#define SES_FLAG_UPDATEVTMAP          (1LL << 19)
#define SES_FLAG_COLORPATCH           (1LL << 20)
#define SES_FLAG_SCROLLLOCK           (1LL << 21)
#define SES_FLAG_SCAN                 (1LL << 22)
