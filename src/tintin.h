...
#define SES_FLAG_CONNECTED            (1LL <<  1)
#define SES_FLAG_CLOSED               (1LL <<  2)
#define SES_FLAG_RUN                  (1LL <<  3)
#define SES_FLAG_PORT                 (1LL <<  4)
#define SES_FLAG_READMUD              (1LL <<  6)
#define SES_FLAG_SCAN                 (1LL <<  7)
#define SES_FLAG_SNOOP                (1LL << 10)
#define SES_FLAG_SPLIT                (1LL << 11)
#define SES_FLAG_SCROLLSTOP           (1LL << 12)
#define SES_FLAG_GAG                  (1LL << 13)
#define SES_FLAG_IGNORELINE           (1LL << 14)
#define SES_FLAG_MAPPING              (1LL << 15)
#define SES_FLAG_UPDATEVTMAP          (1LL << 16)
#define SES_FLAG_MCCP                 (1LL << 20)
#define SES_FLAG_BIG5                 (1LL << 21)
#define SES_FLAG_UTF8                 (1LL << 22)
#define SES_FLAG_U8DW                 (1LL << 23)
#define SES_FLAG_U8CONV               (1LL << 24)
#define SES_FLAG_256COLOR             (1LL << 25)
#define SES_FLAG_COLORPATCH           (1LL << 26)

#define SES_FLAG_CONVERTMETA          (1LL << 32)
#define SES_FLAG_REPEATENTER          (1LL << 33)
#define SES_FLAG_LOGLEVEL             (1LL << 34)
#define SES_FLAG_LOGPLAIN             (1LL << 35)
#define SES_FLAG_LOGHTML              (1LL << 36)
#define SES_FLAG_VERBOSE              (1LL << 37)
//#define SES_FLAG_VERBOSELINE          (1LL << 38)
#define SES_FLAG_SCROLLLOCK           (1LL << 40)
#define SES_FLAG_ECHOCOMMAND          (1LL << 41)
#define SES_FLAG_VERBATIM             (1LL << 42)
#define SES_FLAG_WORDWRAP             (1LL << 43)
#define SES_FLAG_INDENT               (1LL << 44)
#define SES_FLAG_SPEEDWALK            (1LL << 45)
#define SES_FLAG_MATHSTR              (1LL << 46)
...
extern void get_eval_string(struct session *ses, char *str, char *result);
